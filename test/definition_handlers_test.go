...
func createCatalogDefinitionRequest() *inbound.CreateCatalogDefinitionRequest {
	return &inbound.CreateCatalogDefinitionRequest{
		Parser: &inbound.ParserCatalogDefinitionRequest{
			Fields: []*inbound.FieldDefinitionRequest{
				{
		...
		Scraper: &inbound.ScraperCatalogDefinitionRequest{
			ContentSelector: "div.product-list",
			Pagination: &inbound.PaginationDefinitionRequest{
